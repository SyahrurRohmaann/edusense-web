    ...
    <div class="dashboard-section">
        <div class="stats-container">
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <div class="stat-label">Total Permainan</div>
                    <div class="stat-value">24</div>
                    <div class="stat-subtext">Minggu ini: 5 permainan</div>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-subtext">Permainan: Puzzle Hewan</div>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-subtext">Naik 2 level bulan ini</div>
                </div>
            </div>
        </div>
        ...
        <div class="graph-container">
            ...
            <div class="performance-graph">
                <!-- Di sini bisa ditambahkan grafik perkembangan menggunakan ChartJS atau library lain -->
                <div style="text-align: center; padding-top: 80px; color: #888;">
                    Grafik perkembangan kemampuan kognitif, motorik, dan sosial
                </div>
            </div>
        </div>
            ...
            <table class="activity-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>12 Mei, 2025</td>
                        <td>Belajar Angka</td>
                        <td>Menghitung 1-20</td>
                        <td>95</td>
                    </tr>
                    <tr>
                        <td>10 Mei, 2025</td>
                        <td>Mengenal Warna</td>
                        <td>Mencocokkan warna</td>
                        <td>80</td>
                    </tr>
                </tbody>
            </table>
